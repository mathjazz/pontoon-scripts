...
unread_notifications_h2_2020 = notifications_h2_2020.filter(unread=False)

notifications_h2_2020.count()
unread_notifications_h2_2020.count()

notifications_h2_2020.values_list("recipient").distinct().count()
unread_notifications_h2_2020.values_list("recipient").distinct().count()
